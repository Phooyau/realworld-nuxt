  ...
  methods: {
    async onSubmit() {
      try {
        ...
        Cookie.set('rw_user', JSON.stringify(data.user));
        this.$router.push('/');
      } catch (err) {
